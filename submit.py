...
nsml_name = "KR96419"  # NSML ID 넣는 곳
data_name = "airush2022-2-5"  # 데이터 셋
submit_list_path = '../../문서/ai_rush/2-5/KR96419_airush2022-2-5_74/submit.csv'
S_HOUR = 3601
...
if __name__ == "__main__":
    ...
    for i in range(s_df.shape[0]):
        ...
        full_command = f"nsml submit {full_session} {m} --esm {nsml_name} -e BERTclassifier.py"
